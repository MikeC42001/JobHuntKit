...
def print_report(root, rule, report, check_only):
    ...
    print("  3. master/master_cv_minimal.md    distil that into @id-tagged blocks")
    print("  4. master/CV_SPEC.md              decide what's locked vs. per-application")
    print(f'  5. rename "{EXAMPLE_COMPANY}" under applications/offer-pages/ to your first real')
    print("     posting, and edit its application.md")
    print("  6. python engine/build_cv.py --all")
